...
function AccountSetting() {
    ...
    const handleUpdateAccount = (event) => {
        ...
        if (cookies.user.isAslab == false) {
            ...
            params.append('praktikan_profile_picture', uploadedImage);
            ...
            params.append('aslab_profile_picture', uploadedImage);
                    ...
                    <form className='grid grid-cols-6 gap-6'>
                        <div className="col-span-6 sm:col-span-3 items-center">
                            ...
                            <input
                                ...
                                className="
                            mt-2 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200
                            file:bg-gradient-to-b file:from-blue-500 file:to-blue-700
                            file:px-6 file:py-1 file:m-3 file:border-none file:rounded-full
                            file:text-white file:cursor-pointer file:shadow-lg file:shadow-blue-600/50"
                                required
                        ...
                        <div className='col-span-3 sm:flex sm:items-center sm:justify-between'>
                            <button className="w-50 object-center mt-10 inline-block bg-blue-600 text-white px-10 py-3 rounded-md text-sm font-medium transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 dark:hover:bg-blue-700 dark:hover:text-white"
